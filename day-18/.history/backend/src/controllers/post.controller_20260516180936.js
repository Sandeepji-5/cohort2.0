...
async function  getFeedController(req, res){
    const posts = await postModel.find().populate("user", "username profileImage").sort({ createdAt: -1 })  // populate krne se user ke andar se username aur profile image aa jayega post ke sath
    res.status(200).json({
        message:"post fetched Successfully",
        posts
